 ...
 *
 * Edited version of Squiz_Sniffs_Commenting_FunctionCommentSniff to allow bool and int types.
 *
 * @category  PHP
 * @package   PHP_CodeSniffer
 * @author    David Mertl <dmertl@onzra.com>
 */
class OnzraCakePHP2x_Sniffs_Commenting_FunctionCommentSniff extends PEAR_Sniffs_Commenting_FunctionCommentSniff
{

    /**
     * Additional allowed types over PHP_CodeSniffer::$allowedTypes.
     *
     * @var array
     */
    ...
    {
        if (in_array($varType, $this->allowedTypes)) {
            return $varType;
        } else {
